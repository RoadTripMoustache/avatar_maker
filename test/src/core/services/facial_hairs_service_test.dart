...
void main() {
  const String tBeardLightSvgTemplate = """
  ...
  final String tColorId = FacialHairColors.Auburn.id;
  final String tHexCode = FacialHairColors.Auburn.value;

  final String tExpectedGeneratedContent = tBeardLightSvgTemplate
      .replaceAll(TO_REPLACE_WITH_FACIAL_HAIRS_COLOR_NAME, tColorId)
  ...
  group('FacialHairsService - FIX', () {
    ...
    group('generateFacialHair', () {
      test(
        ...
        final String rawSvgContent = tBeardLightSvgTemplate;

        // Act
        final String result = rawSvgContent
            .replaceAll(TO_REPLACE_WITH_FACIAL_HAIRS_COLOR_NAME, tColor.id)
            .replaceAll(TO_REPLACE_WITH_FACIAL_HAIRS_COLOR, tColor.hexCode);
        ...
        expect(result, contains('fill="$tHexCode"')); // Ex: fill="#A55728"
      });

      test('should use default color value', () {
        // Arrange
        final FacialHairColors tDefaultColor = FacialHairColors.Black;

        // Act
        final String result = FacialHairsService.generateFacialHair(
          type: FacialHairTypes.BeardLight,
        );
    ...
    group('drawSVG', () {
      ...
      test(
        ...
        // Act
        final String result = FacialHairsService.drawSVG(
          type: tType,
          color: tColor,
        );
