...
// in avatar_maker/test/src/customizer/widgets/customizer_appbar_test.dart.
...
class MockAvatarMakerController extends _i1.Mock
  ...
  @override
  _i8.Future<List<bool>> clearAvatarMaker() => (super.noSuchMethod(
        Invocation.method(
          #clearAvatarMaker,
          [],
        ),
        returnValue: _i8.Future<List<bool>>.value(<bool>[]),
        returnValueForMissingStub: _i8.Future<List<bool>>.value(<bool>[]),
      ) as _i8.Future<List<bool>>);
...
///
/// See the documentation for Mockito's code generation for more information.
class MockTabController extends _i1.Mock implements _i12.TabController {
  @override
  ...
  void animateTo(
    int? value, {
    Duration? duration,
    _i12.Curve? curve = _i12.Curves.ease,
  }) =>
      super.noSuchMethod(
        Invocation.method(
          #animateTo,
